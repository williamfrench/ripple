        ...
        frame.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent event) {
                if (event.getKeyChar() == 'v') {
                    theBigPicture.setIcon(new ImageIcon(creator.toggleLetsVapour()));
        ...
        frame.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent event) {
                if (event.getKeyChar() == 'r') {
                    theBigPicture.setIcon(new ImageIcon(creator.clearVapours()));
        ...
        frame.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent event) {
                if (event.getKeyChar() == 'f') {
                    theBigPicture.setIcon(new ImageIcon(creator.cycleFunction()));
